<!-- src/components/etl/nodes/ConditionNode.vue -->
<template>
  <div
  ...
  >
    ...
    <div class="branch-list">
      ...
      >
        ...
        <span v-if="branch.isDefault" class="branch-default">(默认)</span>
      </div>
...
// 样式配置
const styleConfig = nodeStyleMap[TaskNodeType.CONDITION]
